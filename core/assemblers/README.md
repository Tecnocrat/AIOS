...
**Key Features**:
- Tree traversal algorithms for codebase analysis
...
- File-level optimization and refactoring
- Individual component management

**Key Features**:
- Intelligent file creation patterns
- Content structure analysis
- File-level coherence measurement
...
**Key Features**:
- **Environmental Context Analysis**: Comprehensive file discovery and analysis
- **Coherence Assessment**: 0-10 scale architectural coherence scoring
- **Pre-Creation Guidance**: Recommendations before creating new files
...
- Module creation from related components
- Import optimization and deduplication

**Key Features**:
- **Semantic Analysis**: Multi-factor file similarity calculation
- **Integration Planning**: Comprehensive consolidation strategies
- **Benefit Assessment**: Quantified improvement scoring
...
1. **Pre-Analysis**: Always run context_assembler before creating new files
2. **Integration Passes**: Regular integration_assembler runs to consolidate logic

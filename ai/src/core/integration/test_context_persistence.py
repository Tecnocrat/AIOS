...
This script tests the context persistence between the C# UI, Python AI, and VSCode Extension
"""
...
class VSCodeExtensionContextTest:
    ...
    def run_context_persistence_tests(self) -> Dict[str, Any]:
        ...
        test_results["context_health"] = self.recovery_system.calculate_context_health()
    ...
    def test_basic_context_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            health_good = self.recovery_system.calculate_context_health("System is working fine")
            assert health_good.is_healthy(), "Healthy context should be detected as healthy"

            # Test degraded context
            health_bad = self.recovery_system.calculate_context_health("Having some issues")
            assert not health_bad.is_healthy(), "Degraded context should be detected"
    ...
    def test_context_loss_detection(self) -> Dict[str, Any]:
        ...
        try:
            ...
            all_detected = all(result["detected"] for result in detection_results)
    ...
    def test_cross_component_sync(self) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"   ✅ Cross-component sync successful (coherence: {coherence:.3f})")
            return {
    ...
    def test_vscode_extension_bridge(self) -> Dict[str, Any]:
        ...
        try:
            ...
            sync_success = self.simulate_context_sync_with_extension(context_data)
    ...
    def test_ai_integration_context(self) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"   ✅ AI integration context persistence: {len(ai_results)} queries processed")
            return {
                ...
                "details": {
                    ...
                    "average_confidence": sum(r["confidence"] for r in ai_results) / len(ai_results)
                }
            }
        except Exception as e:
    ...
    def test_fractal_holographic_memory(self) -> Dict[str, Any]:
        ...
        try:
            ...
            all_success = all(r["success"] for r in memory_results) and sync_result

            print(f"   ✅ Fractal holographic memory: {len(memory_results)} allocations tested")
            return {
    ...
    def simulate_context_sync_with_extension(self, context_data: Dict[str, Any]) -> bool:
...
def main():
    ...
    try:
        ...
        print(f"📈 Overall system coherence: {results.get('context_health', {}).get('score', 0.85):.3f}")

...
try:
    ...
    raise ImportError(
        ...
        "Make sure you are running this script from the project root (e.g., 'python ai/aios_vscode_integration_server.py') "
        "and that the 'aios_vscode_integration' package exists in the 'ai' directory.\n"
        f"Original error: {e}"
    )

...
class AgentConclaveFacade:
    ...
    def _ensure_orchestrator(self):
        ...
        try:
            ...
            raise RuntimeError(f"Failed to import AINLPAgenticOrchestrator: {e}")

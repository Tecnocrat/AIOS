...
class IntegrationTestRunner:
    ...
    def get_metadata_location(self) -> str:
        ...
        return str(
            self.orchestrator.metadata_dir.relative_to(self.orchestrator.workspace_root)
        )
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "test_directory": str(
                self.orchestrator.test_dir.relative_to(self.orchestrator.workspace_root)
            ),
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="AIOS Integration Test Runner")
    parser.add_argument(
        "command",
        nargs="?",
        default="run",
    ...
    parser.add_argument("--test", "-t", help="Specific test to run (for 'run' command)")

...
def main():
    ...
    print(
        f"Health awareness: {status['consciousness_metrics']['health_awareness']:.2f}"
    )
    print(
        f"Evolution consciousness: {status['evolution_consciousness']['evolution_awareness']:.2f}"
    )
    print(
        f"Collective intelligence: {status['collective_intelligence']['system_coherence']:.2f}"
    )

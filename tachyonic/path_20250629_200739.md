...
- **Version Compatibility Matrix**: (Superseded) Former root `environment.yml` replaced by segmented specs under `ai/env/` (base/ai/dev/quantum) plus `requirements.txt`
